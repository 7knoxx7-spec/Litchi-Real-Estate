      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              {language === "ar"
                ? "المنصة العقارية الأكثر تطوراً في الإمارات. نجمع بين الذكاء الاصطناعي والخبرة العقارية لنقدم لك أفضل تجربة."
                : "The most advanced real estate platform in UAE. Combining AI with real estate expertise."}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/properties" className="text-slate-400 hover:text-gold-400 transition-colors">
                  {language === "ar" ? "العقارات" : "Properties"}
                </a>
              </li>
              <li>
                <a href="/maps" className="text-slate-400 hover:text-gold-400 transition-colors">
                  {language === "ar" ? "الخريطة" : "Map"}
                </a>
              </li>
              <li>
                <a href="/adam" className="text-slate-400 hover:text-gold-400 transition-colors">
                  Adam AI
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-slate-800 pt-8 text-center">
          <p className="text-slate-500 text-sm">
            © {new Date().getFullYear()} RoomUAE PRO. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
